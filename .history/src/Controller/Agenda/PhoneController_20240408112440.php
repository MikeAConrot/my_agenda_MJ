    ...
    public function show_phones(){
     ...
     public function edit_phones(Request $request, $idContact){
        ...
        $manager = $this->doctrine->getManager();
         ...
         $phone = $manager->getRepository(Phone::class)->find($idContact);
        ...
        //Pasar el Objeto $contactoRepository que contiene la info  del contacto a editar
         ...
         return $this->render('my_agendamj\Contact\editphone.html.twig',[
            'form' => $form->createView(),
        ]);
     }
     ...
     public function delete_phones($idContact){
        //Manager de doctrine
        $manager = $this->doctrine->getManager();
        //Consulta de Contacto por id
        $contact = $manager->getRepository(Phone::class)->find($idContact);
